    ...
    public class ImportFileFixture : CoreTest
    {
        ...
        public void import_new_file_should_succeed()
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                .Setup(e => e.GetEpisodesByParseResult(It.IsAny<RemoteEpisode>())).Returns(new List<Episode> { fakeEpisode });
        ...
        public void import_file_with_no_episode_in_db_should_skip()
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                .Setup(c => c.GetEpisodesByParseResult(It.IsAny<RemoteEpisode>()))
        ...
        public void import_new_multi_part_file_episode_has_equal_or_better_quality_than_existing(string fileName)
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                .Setup(e => e.GetEpisodesByParseResult(It.IsAny<RemoteEpisode>())).Returns(fakeEpisodes);
        ...
        public void import_new_multi_part_file_episode_replace_two_files()
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                .Setup(e => e.GetEpisodesByParseResult(It.IsAny<RemoteEpisode>())).Returns(new List<Episode> { fakeEpisode1, fakeEpisode2 });
        ...
        public void should_set_parseResult_SceneSource_if_not_in_series_Path()
        {
            ...
            Mocker.GetMock<IEpisodeService>().Setup(s => s.GetEpisodesByParseResult(It.IsAny<RemoteEpisode>()))
                .Returns(new List<Episode>());
            ...
            Mocker.Verify<IEpisodeService>(s => s.GetEpisodesByParseResult(It.Is<RemoteEpisode>(p => p.SceneSource)), Times.Once());
        }
        ...
        public void should_not_set_parseResult_SceneSource_if_in_series_Path()
        {
            ...
            Mocker.Verify<IEpisodeService>(s => s.GetEpisodesByParseResult(It.Is<RemoteEpisode>(p => p.SceneSource == false)), Times.Once());
        }
